        ...
        <div className="p-10 flex items-center justify-between">
          <div className="flex items-center gap-4 min-w-[200px]">
            ...
            <div>
              ...
              <p className="text-[10px] text-agri-gold font-black uppercase tracking-[0.3em] mt-1">Expert Portal</p>
            </div>
          </div>
        ...
        <div className="p-8 border-t border-slate-50 relative min-w-[320px]">
            ...
            {showProfileMenu && (
              ...
              >
                <Link to="/settings" onClick={() => setShowProfileMenu(false)} className="flex items-center gap-3 p-3 hover:bg-slate-50 rounded-xl text-agri-text font-bold transition-colors">
                  <User size={18} className="text-agri-gold" /> Expert Profile
                </Link>
                <button 
                  onClick={() => {
                    alert('Terminating Secure Expert Session...');
          ...
          >
            <div className="flex items-center gap-4">
              <div className="w-12 h-12 rounded-full bg-agri-gold flex items-center justify-center text-agri-green font-black">
                AM
              </div>
              <div className="flex-1 overflow-hidden">
                <p className="text-sm font-black text-agri-text truncate">Dr. A. Mwale</p>
                <p className="text-[10px] text-agri-muted font-bold uppercase truncate">Senior Expert</p>
              </div>
              <motion.div 
